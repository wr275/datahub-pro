              ...
              <div className="product-panel">
                ...
                <div className="panel-body">
                  ...
                  <div style={{marginTop:'12px', display:'flex', gap:'16px', fontFamily:'JetBrains Mono,monospace', fontSize:'10px', color:'var(--muted)'}}>
                    ...
                    <span style={{display:'flex',alignItems:'center',gap:'5px'}}><span style={{width:'12px',height:'4px',background:'rgba(233,30,140,0.3)',borderRadius:'2px',display:'inline-block'}}></span>Projected</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {contactOpen && (
        ...
        >
          ...
          >
            ...
            {/* Logo mark */}
            <div style={{ width:48, height:48, background:'#e91e8c', borderRadius:12, display:'inline-flex', alignItems:'center', justifyContent:'center', color:'#fff', fontWeight:900, fontSize:'1.3rem', marginBottom:20 }}>D</div>
            ...
            {/* Email box */}
            <div style={{ background:'rgba(233,30,140,0.08)', border:'1px solid rgba(233,30,140,0.25)', borderRadius:12, padding:'20px 24px', marginBottom:20 }}>
              ...
              <a href="mailto:hello@datahubpro.co.uk" style={{ fontSize:'1.1rem', fontWeight:800, color:'#e91e8c', textDecoration:'none' }}>
            ...
            <a
              ...
              style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:8, padding:'13px 24px', background:'#e91e8c', color:'#fff', borderRadius:10, fontWeight:700, fontSize:'0.95rem', textDecoration:'none', marginBottom:24 }}
            >
              ✉️ Open in email app →
            </a>
      ...
      {demoOpen && (
        ...
        >
          <div
            onClick={e => e.stopPropagation()}
            style={{
              background:'#1c1916', border:'1px solid rgba(233,30,140,0.3)',
